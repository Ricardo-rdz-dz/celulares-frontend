...
export default function NotaVentaRefacciones() {
  ...
  return (
    <div className="w-full max-w-[21cm] mx-auto bg-white text-black font-sans print:w-[21cm] print:h-[28cm]">
      ...
      {/* MAGIA CSS: Forzamos la altura completa de la hoja y evitamos saltos */}
      ...
      {/* RECUADRO QUE SE ESTIRA (hoja-completa) */}
      <div className="border-2 border-black p-6 hoja-completa flex flex-col relative space-y-4">
        ...
        <div className="text-center border-b-2 border-black pb-3">
          ...
          <p className="text-sm font-bold uppercase tracking-widest mt-2 bg-black text-white inline-block px-4 py-1">Nota de Refacciones</p>
        ...
        <div className="flex justify-between items-center text-base font-bold font-mono">
          <p className="text-lg">FOLIO: <span className="text-emerald-600">#R-{folioVenta}</span></p>
        ...
        {/* MÉTODO DE PAGO */}
        <div className="text-sm bg-gray-50 border border-gray-300 p-4 flex justify-end items-center">
        ...
        {/* CLÁUSULAS DE GARANTÍA ESTRICTAS */}
        <div className="text-xs border-2 border-black p-4 space-y-2 text-justify font-medium bg-red-50/30">
          <p className="font-bold text-center border-b border-black pb-2 uppercase mb-2 text-red-800 text-sm">Términos de Garantía en Refacciones</p>
        ...
        {/* --- SECCIÓN DE QRs Y FIRMAS (mt-auto empuja esto al final) --- */}
        <div className="mt-auto pt-6 border-t-2 border-dashed border-gray-300">
          <div className="grid grid-cols-2 gap-4">
            <div className="p-3 border border-black border-dashed rounded text-center flex flex-col items-center bg-gray-50">
              <p className="font-black text-[10px] tracking-wide mb-2">¡VALORAMOS TU OPINIÓN!</p>
              ...
              <p className="text-[9px] text-gray-500 mt-2">Escanea la encuesta</p>
            </div>
            <div className="p-3 border border-black border-dashed rounded text-center flex flex-col items-center bg-gray-50">
              <p className="font-black text-[10px] tracking-wide mb-2">⭐⭐⭐⭐⭐ RESEÑA</p>
              ...
              <p className="text-[9px] text-gray-500 mt-2">Déjanos 5 estrellas en Google</p>
            </div>
          </div>
          ...
          <div className="pt-6 grid grid-cols-2 gap-10 text-center">
            <div>
              ...
              <p className="text-xs font-bold mt-1.5 uppercase tracking-tighter">Acepto Condiciones y Garantía</p>
            </div>
            <div>
              <div className="border-b-2 border-black w-full h-8"></div>
              <p className="text-xs font-bold mt-1.5 uppercase tracking-tighter">Entregó MovilPlace</p>
            </div>
          </div>
          <p className="text-sm font-black uppercase text-center pt-4">¡Gracias por su compra!</p>
        </div>
